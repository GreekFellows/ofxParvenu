...
void swap(ofxPButton& lhs, ofxPButton& rhs) {
	...
	swap(lhs._labelHorizontalPadding, rhs._labelHorizontalPadding);
	swap(lhs._labelVerticalPadding, rhs._labelVerticalPadding);
}
...
void ofxPButton::calculateMinBox() {
	...
	_minBox.width = _labelBoundingBox.width + 2 * _labelHorizontalPadding;
	_minBox.height = _labelBoundingBox.height + 2 * _labelVerticalPadding;
